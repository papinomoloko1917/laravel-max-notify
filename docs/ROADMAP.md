...
- Phase 8 is in progress through `08d9e2e` plus an uncommitted Camera editing slice: creation, reactive filtering, pagination, and editing are implemented; edit validation coverage and final review remain.

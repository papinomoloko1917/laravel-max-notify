...
- Phase 9 is in progress through `bfc574a` plus an uncommitted duplicate-ID test: the Client creation block is implemented and fully verified; commit/push remains before starting editing.

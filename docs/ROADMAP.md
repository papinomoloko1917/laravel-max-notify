...
- Phase 8 is in progress: the read-only Cameras table slice is pushed in `35039fb`; Camera creation and an active-status list filter are implemented locally but still need focused Livewire tests and filter reactivity.
